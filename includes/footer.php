	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__heading">Contact US</div>
				<ul class="footer-nav__list">
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Phone No:.03037939568</a>
					</li>
					<li class="footer-nav__item">
						<a href="#" class="footer-nav__link">Email at: Talhafraz78665@gmail.com</a>
					</li>
					<li class="footer-nav__item">
						<a href="contact.php" class="footer-nav__link"><u>Click Here For any Queries</u></a>
					</li>
